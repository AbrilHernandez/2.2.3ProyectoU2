...
public class MainActivity extends AppCompatActivity {
    ...
    private void llenarLista(){
        ...
        adapter = new AdaptadorListView(getApplicationContext(), nombre,email,telefono);
